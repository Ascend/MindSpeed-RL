...
更多详情请参考[版本配套表](https://gitcode.com/ascend/MindSpeed-RL/blob/master/docs/zh/install_guide.md#%E7%89%88%E6%9C%AC%E9%85%8D%E5%A5%97%E8%A1%A8)。

# 安装

---

MindSpeed RL具体的安装请参考[安装指南](https://gitcode.com/ascend/MindSpeed-RL/blob/master/docs/zh/install_guide.md#%E5%AE%89%E8%A3%85%E6%8C%87%E5%8D%97)。

# 快速上手

---

  快速在昇腾训练设备上运行 MindSpeed RL可详见[快速入门](https://gitcode.com/ascend/MindSpeed-RL/blob/master/docs/zh/algorithms/grpo.md#grpo)。
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td><a href="docs/zh/algorithms/grpo.md">Doc</a></td>
      <td  rowspan="1">
        <a href="docs/zh/solutions/r1_zero_qwen25_7b.md">Qwen2.5-7B</a> <br>
        <a href="docs/zh/solutions/r1_zero_qwen25_32b.md">Qwen2.5-32B</a> <br>
      </td>
      <td> Released</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td  rowspan="1">
        ...
        <a href="docs/zh/solutions/r1_zero_deepseek_671b.md"> DeepSeek-R1-671B </a> <br>
      </td>
      <td> Preview</td>
    </tr>
    <tr>
      <td> DAPO</td>
      <td><a href="docs/zh/algorithms/dapo.md">Doc</a></td>
      <td  rowspan="1">
    ...
    <tr>
      <td> PPO</td>
      <td><a href="docs/zh/algorithms/ppo.md">Doc</a></td>
      <td  rowspan="1">
    ...
    <tr>
      <td> DPO</td>
      <td><a href="docs/zh/algorithms/dpo.md">Doc</a></td>
      <td  rowspan="1">
...
注意：使用Ray拉起任务的算法，如GRPO，环境变量需要在[runtime_env.yaml](./configs/envs/runtime_env.yaml)处配置。
...
<table>
  ...
  <tbody>
    <tr>
      <td>训推共卡</td>
      <td><a href="docs/zh/features/integrated_worker.md">Doc</a></td>
      <td  rowspan="1">
        GRPO <br>
        DAPO <br>
        PPO <br>
    ...
    <tr>
      <td>数据调度</td>
      <td><a href="docs/zh/features/data_module_design.md">Doc</a></td>
      <td  rowspan="1">
        GRPO <br>
        DAPO <br>
        PPO <br>
    ...
    <tr>
      <td>权重重切分</td>
      <td><a href="docs/zh/features/resharding.md">Doc</a></td>
      <td  rowspan="1">
        GRPO <br>
        DAPO <br>
        PPO <br>
    ...
    <tr>
      <td>填充移除</td>
      <td><a href="docs/zh/features/remove_padding.md">Doc</a></td>
      <td  rowspan="1">
        GRPO <br>
        DAPO <br>
        PPO <br>
    ...
    <tr>
      <td>长序列并行</td>
      <td><a href="docs/zh/features/context_parallel.md">Doc</a></td>
      <td  rowspan="1">
        GRPO <br>
        DAPO <br>
        PPO <br>
    ...
    <tr>
      ...
      <td><a href="docs/zh/features/partial_rollout.md">Doc</a></td>
      <td  rowspan="1">
        GRPO <br>
      </td>
      <td> Preview</td>
...
<table>
  ...
  <tbody>
    <tr>
      <td>训练监控</td>
      <td>  <a href="docs/zh/features/logging_wandb_tensorboard.md">Doc</a> </td>
      <td  rowspan="1">
        GRPO <br>
        DAPO <br>
        PPO <br>
    ...
    <tr>
      <td>性能调优</td>
      <td>  <a href="docs/zh/features/profiler.md">Doc</a> </td>
      <td  rowspan="1">
        GRPO <br>
        DAPO <br>
        PPO <br>
    ...
    <tr>
      <td>精度分析</td>
      <td>  <a href="docs/zh/features/msprobe.md">Doc</a> </td>
      <td  rowspan="1">
        GRPO <br>
        DAPO <br>
        PPO <br>
    ...
    <tr>
      <td>确定性计算</td>
      <td>  <a href="docs/zh/features/deterministic_computation.md">Doc</a> </td>
      <td  rowspan="1">
        GRPO <br>
        DAPO <br>
        PPO <br>
...
[MindSpeed RL 安全声明](./SECURITYNOTE.md)
