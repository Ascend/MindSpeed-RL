...
2. 修改 DEFAULT_YAML 为指定的 yaml，目前已支持的配置文件放置在 configs / 文件夹下，具体参数说明可见 [配置文件参数介绍](../features/grpo_yaml.md)；
...
|------------|------|-----|-----------|-------------------|------------|---------| 
| Qwen25-7B | Atlas A3   | 32  | 8 | 2048              | 2048       | 345     | 
| Qwen25-32B | Atlas A3   | 64  | 16 | 1024              | 2048       | 320     | 
| Qwen25-32B | Atlas A2   | 64  | 16  | 1024              | 2048       | 100     |
