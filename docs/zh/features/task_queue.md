...
通过此环境变量可配置task_queue算子下发队列是否开启和优化等级。具体请参考[TASK\_QUEUE\_ENABLE-Ascend Extension for PyTorch 7.2.0-昇腾社区](https://www.hiascend.com/document/detail/zh/Pytorch/720/comref/Envvariables/Envir_007.html)
...
3. 打开图模式(enforce_eager = False )该值设置为1，否则设置为2。
