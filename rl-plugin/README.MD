...
# 镜像使用
目前，昇腾社区的[昇腾镜像仓库](https://www.hiascend.com/developer/ascendhub/detail/2a71f71cb92643baa95e527b39088e0e)已正式上线镜像资源，为广大开发者提供便捷可用的镜像服务支持。

镜像使用指南详见[verl_docker](./docs/verl_docker.md)
