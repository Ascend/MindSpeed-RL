...
from transformers.models.qwen3_moe.modeling_qwen3_moe import Qwen3MoeRMSNorm, Qwen3MoeMLP, Qwen3MoeSparseMoeBlock, apply_rotary_pos_emb
...
def apply_qwen3_moe_patch():
    ...
    Qwen3MoeSparseMoeBlock.forward = Qwen3MoeSparseMoeBlockPatch.forward
    apply_rotary_pos_emb = apply_rotary_pos_emb_qwen3_npu