...
from mindspeed_rl.utils import TransferDock, GRPOTransferDock
...
@pytest.fixture
def setup_teardown_grpo_transfer_dock(request):
    self = request.instance
    self.max_len = 16
...
@pytest.mark.usefixtures("setup_teardown_grpo_transfer_dock")
