...
# Paths
MODEL_PATH=/data/for_dt/weights/Moonlight-16B-A3B-Instruct
TRAIN_FILE=/data/for_dt/datasets/verl/dapo-math-17k_dedup_r1_sys_prompt_mathdapo.parquet
TEST_FILE=/data/for_dt/datasets/verl/aime-2024.parquet
